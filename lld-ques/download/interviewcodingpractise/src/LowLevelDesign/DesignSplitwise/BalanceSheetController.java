...
public class BalanceSheetController {
    ...
    public void settleUp(User paidByUser, User paidToUser, Double amount) {
        ...
        UserExpenseBalanceSheet paidToUserExpenseBalanceSheet = paidToUser.getUserExpenseBalanceSheet();

        paidByUserExpenseBalanceSheet.getUserVsBalance().get(paidToUser.getUserId()).setAmountOwe(0);
        paidToUserExpenseBalanceSheet.getUserVsBalance().get(paidByUser.getUserId()).setAmountGetBack(0);
    }
